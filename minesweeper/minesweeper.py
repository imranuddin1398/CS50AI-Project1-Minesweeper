...
class Sentence():
    ...
    def known_mines(self):
        ...
        """
        # If count is equal to the number of cells in the set, then all of them are mines
        # Otherwise we can't be sure which ones are mines
...
class MinesweeperAI():
    ...
    def add_knowledge(self, cell, count):
        ...
        # Step 3: Create a new sentence for the neighboring cells
        neighbors = set()
        i, j = cell

        # Iterate over neighboring cells to find unknown ones
        ...
        # Add new sentence if relevant
        if neighbors:
            new_sentence = Sentence(neighbors, count)
            self.knowledge.append(new_sentence)

        # Step 4: Mark new safe cells or mines
    ...
    def update_knowledge(self):
        """
        Updates knowledge by marking new mines or safes based on current knowledge.
        """
        while True:
            new_mines = set()
            new_safes = set()

            # Find all new safe cells and mines from the knowledge
            for sentence in self.knowledge:
                new_mines.update(sentence.known_mines())
                new_safes.update(sentence.known_safes())

            # Mark all the newly discovered mines and safes
    ...
    def infer_new_sentences(self):
        """
        Infers new sentences by combining sentences in the knowledge base.
        """
        inferred_sentences = []
        for sentence1 in self.knowledge:
            for sentence2 in self.knowledge:
                ...
                if sentence1.cells.issubset(sentence2.cells):
                    # Infer new sentence based on the difference
    ...
    def make_random_move(self):
        ...
        remaining_moves = all_possible_moves - self.moves_made - self.mines
